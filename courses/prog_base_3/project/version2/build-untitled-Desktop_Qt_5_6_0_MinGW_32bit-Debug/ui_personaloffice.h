...
public:
    ...
    void setupUi(QWidget *PersonalOffice)
    {
        ...
        test = new QPushButton(PersonalOffice);
        test->setObjectName(QStringLiteral("test"));
        test->setGeometry(QRect(600, 410, 75, 23));
    ...
    void retranslateUi(QWidget *PersonalOffice)
    {
        ...
        test->setText(QApplication::translate("PersonalOffice", "PushButton", 0));
